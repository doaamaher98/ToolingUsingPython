...
def sort_sum(tuples):  
  # +++your code here+++
  finalList = sorted(tuples,key=Key_Sort, reverse = True )
...
def even_tuple(input_tuple):
  # +++your code here+++
  Even_Tuple = (i for i in input_tuple if i % 2 == 0)
  Even_Tuple_Sorted = (sorted(Even_Tuple))
  
  return tuple(Even_Tuple_Sorted) 
